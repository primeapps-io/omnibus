...
sed -i "s/{{PROXY_USE}}/$PRIMEAPPS_PROXY_USE/g" primeapps-auth.xml
sed -i "s/{{PROXY_URL}}/${PRIMEAPPS_PROXY_URL//\//\\/}/g" primeapps-auth.xml
sed -i "s/{{PROXY_VALIDATE_CERTIFICATE}}/$PRIMEAPPS_PROXY_VALIDATE_CERTIFICATE/g" primeapps-auth.xml
...
sed -i "s/{{ENVIRONMENT}}/$PRIMEAPPS_ENVIRONMENT/g" primeapps-app.xml
...
sed -i "s/{{PROXY_USE}}/$PRIMEAPPS_PROXY_USE/g" primeapps-app.xml
sed -i "s/{{PROXY_URL}}/${PRIMEAPPS_PROXY_URL//\//\\/}/g" primeapps-app.xml
sed -i "s/{{PROXY_VALIDATE_CERTIFICATE}}/$PRIMEAPPS_PROXY_VALIDATE_CERTIFICATE/g" primeapps-app.xml
